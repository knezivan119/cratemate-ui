...
export const crateTypeData = {
    location: { icon: 'home',            colour: 'blue-7',   label: 'Location' },
    room:     { icon: 'meeting_room',    colour: 'green-7',  label: 'Room' },
    crate:    { icon: 'inventory_2',     colour: 'amber-8',  label: 'Crate' },
    person:   { icon: 'person',          colour: 'purple-7', label: 'Person' },
    vehicle:  { icon: 'directions_car',  colour: 'red-7',    label: 'Vehicle' },
}

export const crateTypeFallback = { icon: 'folder', colour: 'grey-7', label: 'Other' }
